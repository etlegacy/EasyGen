...
#define BS_TYPEMASKK SS_TYPEMASK
...
void CButtonST::PreSubclassWindow()
{
	...
	ModifyStyle(BS_TYPEMASKK, BS_OWNERDRAW, SWP_FRAMECHANGED);
...
{
	UINT nNewType = (wParam & BS_TYPEMASKK);
	...
	return DefWindowProc(BM_SETSTYLE,
	                     (wParam & ~BS_TYPEMASKK) | BS_OWNERDRAW, lParam);
} // End of OnSetStyle
